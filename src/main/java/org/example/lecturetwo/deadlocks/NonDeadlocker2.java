...
public class NonDeadlocker2 implements Runnable {
    @GuardedBy("from")
    Account from;
    Account to;
    int amount;
    ...
    public static void main(String[] args) {
        ...
        NonDeadlocker2 deadlocker1 = new NonDeadlocker2(account1, account2, 100);
        NonDeadlocker2 deadlocker2 = new NonDeadlocker2(account2, account1, 200);
